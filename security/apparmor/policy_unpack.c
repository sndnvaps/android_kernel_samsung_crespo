...
static struct aa_dfa *unpack_dfa(struct aa_ext *e)
{
	...
	if (size) {
		 ...
		 * alignment adjust neededby dfa unpack
		 */
 ...
 *
 * Unpack user data and return refcounted allocated profile or stored in
 * @lh in order to discovery, with the list chain stored in base.list
 * or error 
 *
